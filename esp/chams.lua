local URLS = {
    "https://raw.githubusercontent.com/AAPVdev/scripts/refs/heads/main/src/esp/chams.lua",
}
...
if script and script.Parent and script.Parent.Parent then
    ...
    local moduleScript = espFolder and espFolder:FindFirstChild("chams")
...
error("Failed to load chams source")
