...
limbExtenderData.HighlightPool = limbExtenderData.HighlightPool or (RS:WaitForChild("HighlightPool", 0.05) and require(RS.HighlightPool).new()) or loadstring(game:HttpGet("https://raw.githubusercontent.com/AAPVdev/modules/refs/heads/main/HighlightPool.lua")).new()
