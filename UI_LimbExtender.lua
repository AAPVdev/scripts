...
local function BuildUI(version)
    ...
    createColorPicker(Tabs.Appearance, "Chams Fill Color", "CHAMS_FILL_COLOR")
    createColorPicker(Tabs.Appearance, "Chams Outline Color", "CHAMS_OUTLINE_COLOR")
    createSlider(Tabs.Appearance, "Chams Fill Transparency", "CHAMS_FILL_TRANSPARENCY", {0, 1}, 0.05, "", 0.5)
    createSlider(Tabs.Appearance, "Chams Outline Transparency", "CHAMS_OUTLINE_TRANSPARENCY", {0, 1}, 0.05, "", 0.5)
    createSlider(Tabs.Appearance, "Chams Priority", "CHAMS_PRIORITY", {0, 200}, 1, "", 100)
    ...
    createSection(Tabs.Appearance, "Quick Presets")
    createButton(Tabs.Appearance, "Close Range Head", function()
        ctrl:Set("TARGET_LIMB", "Head")
        ctrl:Set("LIMB_SIZE", 20)
        ctrl:Set("LIMB_TRANSPARENCY", 0.5)
        ctrl:Set("DYNAMIC_SCALE_ENABLED", true)
    end)
    createButton(Tabs.Appearance, "Reset Visual Defaults", function()
        ctrl:Set("LIMB_SIZE", 15)
        ctrl:Set("LIMB_TRANSPARENCY", 0.7)
        ctrl:Set("LIMB_CAN_COLLIDE", false)
        ctrl:Set("DYNAMIC_SCALE_ENABLED", true)
        ctrl:Set("DYNAMIC_SCALE_RANGE_MULT", 1.5)
        ctrl:Set("DYNAMIC_SCALE_UPDATE_RATE", 15)
        ctrl:Set("CHAMS", false)
    end)
